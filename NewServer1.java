	...
	private int i;
        ...
        public void run()
        {
            try{
                ...
                String Message="";
                String ext[]={".c",".c++",".java"};
                String gcc[]={"gcc","g++","gcj"};
                int c;
             //Get lang to work and this should work!
             /*   
         		lang=inputstream.readLine();
         		dataoutputstream.writeBytes(lang);
                        
         		boolean langask = true;
         	*/
				...
				continue;
         			...
         			else if (message.equalsIgnoreCase("java"))
				{
				 c=2;
				continue;
				}
			...
			FileOutputStream  fout = new FileOutputStream("/home/ashwin/test"+i+ext[c]);
			fout.write(str);
                fout.close();
                System.out.println("Hello\n");
                 
                FileOutputStream  fout1 = new FileOutputStream("/home/ashwin/input"+i);
                 ...
                 String[] psCmd =
                    {
                        "sh",
                        "-c",
                        gcc[c]" -o /home/ashwin/test"+i+" /home/ashwin/test"+i+ext[c]
                    };
                  String sout="",serr="",s="";
                  ...
                  {   String[] psCmd1 =
                    {
                        "sh",
                        "-c",
                        "/home/ashwin/test"+i+" < /home/ashwin/input"+i
                    };
                    sout="";serr="";s="";
        ...
        public void show(){
		  ...
		  ServerSocket server = new ServerSocket(1436);
		        ...
		        try
			   {
                       ...
                       new ConnectionHandler(socket,i);
				  i++;
                    }
                    catch(Exception e1)
                    {
